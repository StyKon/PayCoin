...
class FrontendController extends Controller
{
    ...
    public function productGrids(Request $request){
        $childcategorys=Category::getAllChildBySlagCat($request->slug);
        $products=Product::getProductByCategorySlug($request->slug);

        // Sort by name , price, category
        return view('frontend.pages.product-grids')->with('products',$products)->with('childcategorys',$childcategorys->child_cat);
