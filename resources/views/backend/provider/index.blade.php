...
@section('title','PayCoin || Provider Page')
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary float-left">Provider List</h6>
    ...
    <div class="card-body">
      <div class="table-responsive">
          ...
          <tbody>
            @foreach($providers as $provider)
                <tr>
                    ...
                    <td>
                        <a href="{{route('provider.edit',$provider->id)}}" class="btn btn-primary btn-sm float-left mr-1" style="height:30px; width:30px;border-radius:50%" data-toggle="tooltip" title="edit" data-placement="bottom"><i class="fas fa-edit"></i></a>
        ...
        @else
          <h6 class="text-center">No providers found!!! Please create provider</h6>
        @endif
      </div>
    </div>
</div>
...
@push('scripts')
  ...
  <script src="{{asset('backend/summernote/sweetalert.min.js')}}"></script>
