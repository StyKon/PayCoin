...
<div class="container-fluid">
  <div class="row">
    <div class="col-1 l-flex-child-2 sleft">
    <div class="option">
            ...
            <div class="link">  {{$sub_menu->title}} <i class="fa fa-chevron-down"></i></div>
              <div class="submenu ">
                ...
                @foreach($sub_menu->providers as $provider)
                    <div class="col-3 remove-padding"><a href="{{route('product-provider',[$cat_info->slug,$sub_menu->slug,$provider->slug])}}"><img src="{{$provider->logo}}"><h8>{{$provider->companyname}}</h8>  </a></div>
                    @endforeach
                </div>
              </div>
</div>
